...
def compute(orig_sent, similar_sent, n_gram = 2):
  """Compute BLEU scores and handling BPE."""
  #
  #per_segment_references = [ [["tao","là"]] 2
  max_order = n_gram
  smooth = True  
  src_tokens = orig_sent.split(" ")
  target_tokens = similar_sent.split(" ")
  per_segment_references =  [[src_tokens]] 
  translations =   [target_tokens] 
